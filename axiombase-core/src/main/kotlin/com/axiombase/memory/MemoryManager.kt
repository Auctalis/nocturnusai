...
import com.axiombase.core.SourceType
 ...
 *
 * This is the core differentiator for AxiomBase as an agentic AI context server.
...
class MemoryManager(
    ...
    fun onRuleAsserted(rule: com.axiombase.core.Rule, tenantId: String?) {
