"""Pydantic models for the AxiomBase Python SDK.

These models mirror the server-side DTOs and provide structured,
validated representations of AxiomBase API responses.
"""
...
class Atom(BaseModel):
    """A single unit of knowledge in the AxiomBase knowledge base.
