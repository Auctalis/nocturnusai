...
Average context per turn drops from roughly 2,400 tokens to 30. Not through compression. Not through summarization. Through **derivation** — sending only what is logically necessary, because we know what is logically necessary.
...
|---|---|---|---|
| Tokens per turn | ~2,400 | ~800 | **~30** |
| Cost per 1M turns (Sonnet) | $7,200 | $2,400 | **$90** |
| Latency | high | medium | **low** |
| Truth-preserving | no | no | **yes** |

A SaaS workload that costs **$54,000 a month** on a naive architecture costs around **$240 a month** on Nocturnus. Same model. Same outputs. **225× lower bill.**
...
**Token cost** — which we have already addressed. 50× to 200× reduction in inference spend, depending on workload.
