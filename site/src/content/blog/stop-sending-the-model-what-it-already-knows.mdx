...
cover:
  src: "/blog-launch-cover.jpg"
  alt: "Nocturnus launch infographic showing the context server architecture, benchmark math, framework integrations, and the problems it solves."
---
